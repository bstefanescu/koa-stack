...
exports.Resource = exports.Router = exports.AbstractRouter = exports.RouterContext = void 0;
const koa_compose_1 = __importDefault(require("koa-compose"));
const koa_send_1 = __importDefault(require("koa-send"));
const path_1 = require("path");
const error_js_1 = require("./error.js");
const path_matchers_js_1 = require("./path-matchers.js");
const ServerError_js_1 = require("./ServerError.js");
class RouterContext {
    constructor(ctx) {
        ...
        this.path = (0, path_matchers_js_1.normalizePath)(ctx.path);
        ctx.$router = this;
    }
...
class EndpointRoute {
    constructor(router, method, pathPattern, target, thisArg) {
        ...
        this.router = router;
        this.pathPattern = (0, path_matchers_js_1.normalizePath)(pathPattern);
        this.method = method ? method.toUpperCase() : null;
        this.matcher = (0, path_matchers_js_1.createPathMatcherUnsafe)(this.pathPattern);
        this.target = target;
...
class ServeRoute {
    constructor(prefix, target, opts = {}) {
        ...
        this.matcher = (0, path_matchers_js_1.createSimplePrefixMatcher)((0, path_matchers_js_1.normalizePath)(prefix));
        this.target = target;
        this.opts = opts;
    }
    match(ctx, path) {
...
class AbstractRouter {
    constructor(prefix = '/', opts = {}, parent) {
        ...
        this.prefix = (0, path_matchers_js_1.normalizePath)(prefix);
        this.webRoot = opts.webRoot || process.cwd();
        this.errorHandlerOpts = opts.errorHandlers;
        this.prefixMatcher = (0, path_matchers_js_1.createPathPrefixMatcherUnsafe)(this.prefix);
        this.parent = parent;
    }
    get absPrefix() {
    ...
    getAbsPath(path) {
        let abspath = path ? (0, path_1.join)(this.absPrefix, path) : this.prefix;
        return (0, path_matchers_js_1.normalizePath)(abspath);
    }
    match(ctx, path) {
    ...
    async _dispatch(ctx) {
        ...
        if (ctx.$router._maybe405) {
            throw new ServerError_js_1.ServerError(405, 'Method ' + ctx.method + ' not allowed on endpoint ' + ctx.$router._maybe405);
    ...
    onError(ctx, err) {
        return (0, error_js_1.errorHandler)(ctx, err, { htmlRoot: (0, path_1.join)(this.webRoot, '/errors'), ...this.errorHandlerOpts });
    }
    withGuard(guard) {
        this.guard = guard;
        return this;
